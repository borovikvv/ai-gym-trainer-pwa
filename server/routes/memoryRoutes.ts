...
memoryRoutes.get('/coach/memory-facts/:userId', requireAllowedUserId, async (req, res) => {
...
memoryRoutes.post('/coach/memory-facts/:userId', requireAllowedUserId, async (req, res) => {
...
memoryRoutes.patch('/coach/memory-facts/:userId/:id', requireAllowedUserId, async (req: Request, res: Response) => {
  const userId = String(req.params.userId)
...
memoryRoutes.get('/coach/goals/:userId', requireAllowedUserId, async (req: Request, res: Response) => {
...
memoryRoutes.post('/coach/goals/:userId', requireAllowedUserId, async (req: Request, res: Response) => {
  const userId = String(req.params.userId)
...
memoryRoutes.patch('/coach/goals/:userId/:id', requireAllowedUserId, async (req: Request, res: Response) => {
  const userId = String(req.params.userId)
  const id = String(req.params.id)
