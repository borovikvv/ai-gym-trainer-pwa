...
coachRoutes.get('/coach/state/:userId', requireAllowedUserId, async (req, res) => {
...
coachRoutes.post('/coach/workout-today', requireAllowedUserId, async (req, res) => {
...
coachRoutes.get('/coach/training-records/:userId', requireAllowedUserId, async (req, res) => {
  const userId = String(req.params.userId)
...
coachRoutes.get('/coach/training-records/:userId/export', requireAllowedUserId, async (req, res) => {
  const userId = String(req.params.userId)
...
coachRoutes.get('/coach/training-records/:userId/latest', requireAllowedUserId, async (req, res) => {
  const userId = String(req.params.userId)
