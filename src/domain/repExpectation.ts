 ...
 * на том же весе человек стабильно недобирает повтор к ожиданию. Единый источник
 * сигнала «усилие выросло на тех же весах» и для уровня блока
 * (mesocycleBlockGoal.effortRising), и для уровня недельного объёма
 * (weeklyVolumeTargets) — критерий 2 из #248.
 */
