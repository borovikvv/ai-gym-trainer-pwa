...
export const dayA: WorkoutDay = {
  ...
  exercises: [
    ...
    },
    {
      ...
      targetMuscles: ['верх груди', 'передняя дельта'],
    ...
    },
    {
      ...
      muscleGroup: 'Спина',
      targetMuscles: ['широчайшие', 'ромбовидные', 'бицепс'],
    ...
    },
    {
      ...
      name: 'Планка',
      muscleGroup: 'Кор',
      targetMuscles: ['прямая мышца живота', 'поперечная мышца'],
...
export const dayB: WorkoutDay = {
  ...
  exercises: [
    ...
    },
    {
      ...
      targetMuscles: ['задняя поверхность бедра', 'ягодицы', 'поясница'],
    ...
    },
    {
      ...
      targetMuscles: ['ягодицы', 'квадрицепс'],
    ...
    },
    {
      ...
      muscleGroup: 'Икры',
      targetMuscles: ['икроножная', 'камбаловидная'],
  ...
  exercises: [
    {
      ...
      muscleGroup: 'Спина',
      targetMuscles: ['широчайшие', 'ромбовидные'],
      prescription: '3×8–10 · рекомендовано 55 кг · отдых 120 сек',
      setsCount: 3,
      repMin: 8,
      repMax: 10,
    ...
    },
    {
      ...
      targetMuscles: ['задняя дельта', 'ромбовидные', 'вращательная манжета'],
    ...
    },
    {
      ...
      muscleGroup: 'Руки',
      targetMuscles: ['бицепс', 'предплечье'],
