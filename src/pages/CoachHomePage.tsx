...
import type { Screen, WorkoutDay } from '../../shared/types'
...
interface CoachHomePageProps {
  ...
  // Coach state (previously via CoachContext, now passed as props)
 ...
 *
 * Pulls program data from ProgramContext; coach state is passed as props
 * (previously via CoachContext — collapsed in #146 since this was the only
 * consumer). Calls useExtraWorkoutToday with lifted state so App can share
