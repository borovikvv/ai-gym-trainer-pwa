...
const generatedExerciseGuideImages: Record<string, string> = {
  ...
  'barbell-overhead-press': '/exercise-guides/barbell-overhead-press-gpt.png',
  'barbell-row': '/exercise-guides/barbell-row-gpt.png',
  ...
  'cable-crossover': '/exercise-guides/cable-crossover-gpt.png',
  ...
  'conventional-deadlift': '/exercise-guides/conventional-deadlift-gpt.png',
  'db-shoulder-press': '/exercise-guides/db-shoulder-press-gpt.png',
  'dead-bug': '/exercise-guides/dead-bug-gpt.png',
  'decline-bench-crunch': '/exercise-guides/decline-bench-crunch-gpt.png',
  ...
  'dumbbell-bench-press': '/exercise-guides/dumbbell-bench-press-gpt.png',
  ...
  'lateral-raise-dumbbell': '/exercise-guides/lateral-raise-dumbbell-gpt.png',
  ...
  'machine-crunch': '/exercise-guides/machine-crunch-gpt.png',
  ...
  'rear-delt-raise-dumbbell': '/exercise-guides/rear-delt-raise-dumbbell-gpt.png',
  'romanian-deadlift': '/exercise-guides/romanian-deadlift-gpt.png',
  'captain-chair-knee-raise': '/exercise-guides/captain-chair-knee-raise-gpt.png',
  'seated-calf-raise': '/exercise-guides/seated-calf-raise-gpt.png',
  'side-plank': '/exercise-guides/side-plank-gpt.png',
  'single-arm-dumbbell-row': '/exercise-guides/single-arm-dumbbell-row-gpt.png',
